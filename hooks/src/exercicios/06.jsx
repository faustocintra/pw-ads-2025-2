...
//Criando constantes somente-leitura a partir da desestruturação da nova variável de estado
// para maximizar a compatibilidade com o código já existente
  ...
  React.useEffect(() => {
    ...
    fetchPokemon(pokemonName)
      ...
      .catch(error => {
        ...
        //em vez de error: error, podemos usar apenas error, como efeito da propriedade abreviada.
