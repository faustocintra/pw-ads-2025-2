...
function PokemonInfo({pokemonName}) {
  ...
  // da nova variavel de estado para maximizar a compatibilidade com o 
  // codigo ja existente
  ...
  React.useEffect(() => {
    ...
    fetchPokemon(pokemonName)
      .then(pokemonData => {
        ...
        //...state copía o estado atual antes de alterá-lo
  ...
  // Este useEffect será executado apos qualquer alteração,
  // para podermos visualizar a quantidade de atualizaçoes
  React.useEffect(()=> {
