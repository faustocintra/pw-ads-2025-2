...
function Greeting({initialName = ''}) {
  ...
  const [name, setName] = React.useState(
    ...
    // é FORNECIDO POR UMA FUNÇÃO, garantimos que esse valor inicial seja
    // atribuido apenas uma vez, na fase de montagem do componente
    () => window.localStorage.getItem('name') ?? initialName
  )
...
function Exercicio02() {
  return <Greeting  initialName='Orozinho'/>
}
