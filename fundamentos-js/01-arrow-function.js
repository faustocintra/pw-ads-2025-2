...
/* 
    Função equivalente, usando sintaxe arrow function
    ~> não necessita de chaves
    ~> não necessita de parenteses em volta do parametro
    ~> não necessita da palavra-chave "return"
    ~> a palavra "function" é substituida pela flecha
        => LOGO APÓS o parametro
    ~> a arrow function é invocada usando o nome da constante que a recebe em atribuilção
*/ 
...
/*
    Equivalente em sintaxe arrow funcion
...
/*
    Equivalente na sintaxe arrow function
    ~> Não há economia de linhas de corpo da função. MESMO ASSIM, É COMUM ENCONTRAR
    AROW FUNCIONS DE VÁRIAS LINHAS EM PROJETOS REACT
