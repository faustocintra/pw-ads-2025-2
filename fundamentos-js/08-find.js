/* O método de vetores find() encontra o PRIMEIRO ELEMENTO que corresponda ao retorno
de uma frunção passada como parâmetro */
...
console.log('Primeira fruta terminando com "r":',
    frutas.find(f => f.slice(-1) === 'r') //o -1 é o primeiro de trás pra frente
)
