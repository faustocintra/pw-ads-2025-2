/*
    reduce() é um método de vetores que REDUZ o vetor a unico valor.
    Para isso, aplica uma função a cada elemento do vetor, a qual efetua
    uma operação sobre o elemento e acumula o resultado a cada
    passada.
*/
...
/*
    Usando o reduce() para somar todos os elementos do vetor numeros
...
// Concatenando  o vetor de frutas em uma unica string, separando
// os elementos por ';' e convertendo para maiusculas
