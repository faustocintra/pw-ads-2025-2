/*
    ...
    uma operação sobre o elemento e acumula o resultado a cada passada
*/
...
/*
    ...
    A função callback do reduce(), em sua forma mais simples,
    possui dois parâmetros:
    1º ~> é o acumulador, que armazena o resultado das operações
          sobre os elementos anteriores
    2º ~> correspone ao elemento que está sendo processado no
          momento
*/
