...
// Math.min() e Math.max() não conseguem trabalhar com os números estando em um vetor
console.log('Valores em vetor: ', {minimo, maximo})

/*
    A sintaxe de espalhamento (spreading), representada por ... antes do nome da varável, é capaz de "desempacotar" um vetor em uma série de valores avulsos
*/
minimo = Math.min(...nums)
maximo = Math.max(...nums)
