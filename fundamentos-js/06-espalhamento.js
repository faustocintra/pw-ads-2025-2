...
console.log('Valores avulso:', {minimo,maximo})
...
// Math.min() e Math.max não conseguem trabalhar com os números
// estando em um vetor
...
// Fazendo a cópia do objeto usando espalhamento
const carro2 = {...carro1}
...
function soma (...nums){
    // nums é recebido dentro de uma função como vetor
    let resultado = 0
