...
console.log("Valores avulsos: ", {minimo, maximo}) //Não é possível utilizar a propriedade abreviada com template string, deve-se usar JSON.stringfy()

//E se a série de números estiver em um vetor?
const nums = [2, -5, 4, 1, -3, 10]
...
/*
    ...
    um vetor em um série de valores avulsos
*/

minimo = Math.min(...nums)
maximo = Math.max(...nums)

console.log(`Valores em vetor após espalhamento: ${JSON.stringify({minimo, maximo})}`)
