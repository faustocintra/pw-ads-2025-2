<<<<<<< HEAD
//codeshare.io/faustocintra  copiar o código

/*
O método de vetores map() cria um novo vetor na qual cada elemento 
...
/*Gerando um novo vetor em que cada elemento corresponde ao valor do elemento original
elevado ao quadrado*/
const quadrados = numeros.map(n => n ** 2)
console.log('Vetor com números ao quadrado:', quadrados)

/*map() que transforma os elementos do vetor original em itens de lista para uso em HTML
(aplicação frequente em React)*/
const itensLista = frutas.map(f => '<li>${f}</li>')
console.log('Vetor com ítens da lista:', itensLista)
