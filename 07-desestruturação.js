/* 
    DESESTRUTURAÇÃO é a operação pelo qual é possível extrair valores individuais de vetores e objetos, atribuindo-os a variáveis avulsas
*/
...
//Destruturação parcial: 2º e 3º valores
const[, m , n] = carros
console.log(`Segundo e terceiro carros: `, {m, n})

console.log('-'.repeat(80)) //traço separador

//PROBLEMA: troca de valres de variaveis entre si (swap)
let v1 = 10, v2 = 20
console.log('Valores originais: ',{v1, v2})

//Modo clássico de fazer swap (usando variavél auxiliar)
let aux = v1
v1 = v2
v2 = aux

//para comentar seleciona, aperta ctrl e ;
...
/*
    ...
    -> Pode ser feita a desestruturaçõ parcial
*/
