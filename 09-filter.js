...
//Cria um novo vetor com os números negativos
console.log('Apenas os números negativos:', numeros.filter(n => n < 0))

//Cria um novo setor apenas com os números pares 
console.log('Apenas números pares:', numeros .filter( i => i % 2 === 0))

//Cria um novo setor apenas com números maiores que 20
console.log('Apenas números maiores que 20:', numeros.filter(x => x > 20))

//Novo vetor apenas com as frutas que começam com "m"
console.log('Apenas frutas com inicial "m" ', frutas.filter(el => el.charAt(0) === 'm'))

//Novo vetor apenas com as frutas que terminem com "r"
console.log('Apenas frutas que terminam em "r": ', frutas.filter( fru => fru.slice(-1) === 'r'))
